...
//----------------------------------------------------------------------
// List<T>::RemoveFront
//      Remove the this->first "item" from the front of the list.
...
void List<T>::Remove(T item)
{
    ...
    // if this->first item on list is match, then remove from front
...
void SortedList<T>::Insert(T item)
{
    ...
    { // look for this->first elt in list bigger than item
